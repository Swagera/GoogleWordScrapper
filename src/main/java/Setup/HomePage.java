...
public class HomePage {
    ...
    public static void search(String location, String from, String to, String monthFrom, String monthTo) {
        WebElement searchBox = driver.findElement(By.id(":Ra9:"));
        searchBox.click();
        searchBox.sendKeys(location);
        datePicker(from, to, monthFrom, monthTo);
    ...
    public static void datePicker(String from, String to, String monthFrom, String monthTo) {
        wait = new WebDriverWait(driver, 10);
        driver.findElement(By.xpath("//button[@class='d47738b911 e246f833f7 fe211c0731']")).click();
        if (isMonth(monthFrom)) {
